  ...
  exports['default'] = Controller.extend({
    ...
    actions: {
      ...
      addhost: function addhost() {
        ...
        var data = this.get('hostinfos').create(this.get('hostInfos'));
...
define('meg/utils/ajax', ['exports', 'ember'], function (exports, _ember) {
...
define('meg/utils/ajax12', ['exports', 'meg/utils/is-fastboot'], function (exports, _megUtilsIsFastboot) {
...
if (!runningTests) {
  require("meg/app")["default"].create({"LOG_ACTIVE_GENERATION":true,"LOG_TRANSITIONS":true,"LOG_TRANSITIONS_INTERNAL":true,"LOG_VIEW_LOOKUPS":true,"name":"meg","version":"0.0.0+069c0f39"});
}
